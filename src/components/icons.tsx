...
export function FootballIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      {/* Football shape — pointed oval tilted 45° */}
      <ellipse cx="12" cy="12" rx="10" ry="5.5" transform="rotate(-45 12 12)" />
      {/* Center seam running the length of the ball */}
      <line x1="6" y1="18" x2="18" y2="6" />
      {/* Cross laces perpendicular to seam */}
      <line x1="9.4" y1="12.6" x2="11.4" y2="14.6" />
      <line x1="10.6" y1="11.4" x2="12.6" y2="13.4" />
      <line x1="11.8" y1="10.2" x2="13.8" y2="12.2" />
...
export function BasketballIcon({ size = 24, className }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M12 2v20" />
      {/* Left curved seam */}
      <path d="M4.5 4.5c3 3.5 3 11.5 0 15" />
      {/* Right curved seam */}
      <path d="M19.5 4.5c-3 3.5-3 11.5 0 15" />
    </svg>
  );
}

export function ZapIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BuyMeACoffeeIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
